// src/pages/admin/partners/edit.tsx
...
const AdminPartnersEdit = () => {
  const { id } = useParams<{ id: string }>();
  const { tenants, fetchSuperAdminData, updateTenant } = useSupabaseData();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await updateTenant(id!, { name, email, plan, status });
...
export default AdminPartnersEdit;
